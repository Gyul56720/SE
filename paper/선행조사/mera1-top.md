...
MERA-1 v1.0 디지털 RTL 제어 및 인터페이스 블록
...
- 제공된 입력 텍스트에 쓰임새, 문제, 회로, 수에 대한 정보가 전혀 없어 사양을 임의로 유추할 경우 실제 요구사항과 어긋날 위험
- 외부 아날로그 블록과의 인터페이스 타이밍 및 제어 규격이 명시되지 않아 통합 시 오작동할 위험
