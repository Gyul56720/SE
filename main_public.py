...
PUBLIC_SYSTEM_PROMPT = (
    ...
    "**Write your answer in English, not Korean** (user, 2026-09-15). This is EDA work: the vocabulary, the tool flows and the datasheets are all English. Korean labels in a drawing also come out as tofu boxes when the font is missing.\n"
    "\n"
