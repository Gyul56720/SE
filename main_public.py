...
from bot_tools import (
    search_memory, save_memory, run_shell, read_image, read_pdf, draw_circuit, simulate_inspection,
...
PUBLIC_TOOLS = [search_memory, save_memory, run_shell, read_image, read_pdf, draw_circuit, simulate_inspection,
                run_rtl, lint_rtl, synth_rtl, prove_rtl, place_rtl, ip_signoff, serdes_link, quant_sweep, adc_sweep, loss_sweep, nn_equalizer, eq_area, run_spice, spice_example, monte_carlo, concept, textbook]
