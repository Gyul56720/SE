...
표 = {
    ...
    # --- 변환기·표본화 보강 (T5·T6, 2026-09-20) ---
    "커패시터": "capacitor cap array unit",
    "배열": "array elements unit cells",
    "정합": "matching mismatch sigma pelgrom",
    "세그먼테이션": "segmentation thermometer binary dac",
    "단조성": "monotonic monotonicity dnl",
    "미싱코드": "missing code dnl monotonic",
    "글리치": "glitch energy dac switching",
    "중복성": "redundancy sub-binary radix correction",
    "보정": "calibration correction foreground background",
    "인터리브": "time interleaved slices skew spur",
    "구경": "aperture sampling instant jitter",
    "지터한계": "jitter limited snr enob aperture",
    "표본화": "sampling nyquist aliasing aperture",
    "엘리어싱": "aliasing folding nyquist zone",
    "나이키스트": "nyquist zone sampling rate",
    "부트스트랩": "bootstrapped switch constant vgs",
    "플래시": "flash adc comparators parallel",
    "파이프라인변환기": "pipeline adc stage gain residue",
    # --- 표준 ---
