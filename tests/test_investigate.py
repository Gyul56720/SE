...
_원 = (I.두뇌, I.판정기, I.진단기, I.모으기, I.머지기, I.대조기, I.절제검사기, I.열쇠검사기)
머지호출 = []
try:
    ...
    ok("검사무효" in 단 and 단[-5:] == ["검사유효", "절제성립", "열쇠성립", "머지", "끝"], f"원장에 무효 -> 유효 -> 절제 -> 열쇠 -> 머지가 남는다 ({단})")
    ...
    ok("절제안잡힘" in 단 and 단[-5:] == ["검사유효", "절제성립", "열쇠성립", "머지", "끝"], f"원장에 절제안잡힘 -> 절제성립 -> 머지가 남는다 ({단})")
    ...
    I.두뇌, I.판정기, I.진단기, I.모으기, I.머지기, I.대조기, I.절제검사기, I.열쇠검사기 = _원
