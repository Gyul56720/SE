...
IMPOSSIBLE = [
    ("남의 능력치와 약점이 숫자로 보인다", "한 번 본 상대는 계속 갱신된다", "동시에 세 명까지"),
    ...
    ("남의 성장 한계치가 보인다", "누굴 키울지 틀리지 않는다", "직접 만난 사람만"),
    ("죽은 자의 마지막 기억을 읽는다", "아무도 모르는 것을 안다", "하루 한 번"),
    ("등급 판정을 속일 수 있다", "약해 보이는 쪽을 고를 수 있다", "협회 장비 앞에서만"),
]
...
VOICE = [
    ...
    ("숫자를 먼저", "수치와 등급을 앞에 놓고 설명을 뒤에 붙인다"),
