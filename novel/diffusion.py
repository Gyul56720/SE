...
LIMITS = {
    ...
    # **표본에서 온다**(targets.json). 우리가 두었던 6 은 짐작이었고, 표본 154토막의
    # 가운뎃값은 4 였다. 폭은 1~14 라 대목마다 다르다.
    "rally": int(TG.mid("rally", 6)),
    # **표본에는 긴 대사가 없다**(talk_len 0.00 · 네 작품 전부). "120자 넘는 대사
    # 하나는 있어야 한다" 는 요구는 우리가 지어낸 것이었다. 0 이면 안 시킨다.
    "huge": 0,      # 아주 긴 대사(120자+)가 적어도 하나
