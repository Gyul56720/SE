...
웹소설 규격(보고서 기준):
    1회차 = 공백 포함 6,000자 (2026-09-04 상향: 5,000 -> 6,000)
    중대형 사건 15~20개, 하나당 10~15화
"""
from __future__ import annotations

CHARS_PER_EPISODE = 6000
TOTAL_EPISODES = 200

# 회차 하나는 씬 하나가 아니다. 첫 실측에서 씬 하나가 1,200자였는데 회차는 6,000자다.
# 보고서: **서브플롯이 분량의 2/3를 채운다.** 메인 사건만으로 6,000자를 채우면 위기-해결-
# 보상의 원패턴이 노골적으로 드러나 지루해진다. 그래서 회차를 이렇게 쪼갠다:
#
#   척추(메인) 1씬  +  서브플롯 2씬  =  1 회차
#   ~2,000자          ~4,000자          6,000자
#
