...
# 이 저장소에서 내가 손대는 자리인 law · lol · brief · brain 검사만 돌리고, 나머지는 CI 가 뒤늦게
...
for f in tests/test_law_*.py tests/test_lol_*.py tests/test_brief*.py tests/test_brain.py tests/test_pr_merged.py; do
    [ -e "$f" ] || continue
