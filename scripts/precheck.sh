...
for f in tests/test_law_*.py tests/test_lol_*.py tests/test_brief*.py tests/test_jaso_*.py tests/test_coin_*.py tests/test_dig.py tests/test_dig_비언어.py tests/test_dig_더캐기.py tests/test_dig_loop.py tests/test_study.py tests/test_channels.py tests/test_discord_check.py tests/test_discord_cmd.py tests/test_dispatch.py tests/test_sandbox.py tests/test_audit.py tests/test_graph.py tests/test_graph_판정.py tests/test_night_돌리기.py tests/test_eval.py tests/test_eval_tasks.py tests/test_도구수.py tests/test_harvest.py tests/test_mail.py tests/test_repair.py tests/test_secaudit.py tests/test_codify.py tests/test_harvest_논문.py tests/test_research.py tests/test_plan.py tests/test_compact.py tests/test_create_pr.py tests/test_probe_thinking.py tests/test_gate_fix.py tests/test_acceptance.py tests/test_ci_watch.py tests/test_commit_guard.py tests/test_dispatch_tool.py tests/test_impact.py tests/test_스크립트로_돈다.py tests/test_entrypoints.py tests/test_rehearsal.py tests/test_improve.py tests/test_router.py tests/test_intent.py tests/test_gate_g020.py tests/test_relay.py tests/test_toolgate.py tests/test_delegate.py tests/test_말과_한것.py tests/test_brain.py tests/test_reason.py tests/test_pr_merged.py; do
    [ -e "$f" ] || continue
