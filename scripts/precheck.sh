...
for f in tests/test_law_*.py tests/test_lol_*.py tests/test_brief*.py tests/test_dig.py tests/test_study.py tests/test_channels.py tests/test_discord_check.py tests/test_말과_한것.py tests/test_brain.py tests/test_reason.py tests/test_pr_merged.py; do
    [ -e "$f" ] || continue
