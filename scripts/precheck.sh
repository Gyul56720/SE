...
for f in tests/test_law_*.py tests/test_lol_*.py tests/test_brief*.py tests/test_jaso_*.py tests/test_coin_*.py tests/test_dig.py tests/test_dig_더캐기.py tests/test_dig_loop.py tests/test_study.py tests/test_channels.py tests/test_discord_check.py tests/test_discord_cmd.py tests/test_dispatch.py tests/test_sandbox.py tests/test_audit.py tests/test_graph.py tests/test_graph_판정.py tests/test_night_돌리기.py tests/test_eval.py tests/test_말과_한것.py tests/test_brain.py tests/test_reason.py tests/test_pr_merged.py; do
    [ -e "$f" ] || continue
