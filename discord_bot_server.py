...
from bot_tools import (  # noqa: E402
    REPO_DIR, run_shell, run_experiment, run_probes, read_file, read_image, draw_circuit, run_rtl, lint_rtl, synth_rtl, prove_rtl, run_spice, spice_example, edit_file, delegate, send_email, repair, set_key, security_audit, codify_paper, research, create_pr, dispatch_command, search_memory, save_memory,
...
ADMIN_TOOLS = [run_shell, run_experiment, run_probes, read_file, read_image, draw_circuit, run_rtl, lint_rtl, synth_rtl, prove_rtl, run_spice, spice_example, edit_file, delegate, send_email, repair, set_key, security_audit, codify_paper, research, create_pr, dispatch_command, search_memory, save_memory,
