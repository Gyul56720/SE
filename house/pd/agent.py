...
def 보고서(m: dict) -> RPT.보고서:
    ...
    if 경:
        ...
        R.글("레이아웃 그림(그림 3)은 셀이 <b>어디 있나</b>를 보이지 그것이 "
            "<b>무엇인지</b>는 안 보인다 — 빨간 네모 3,500개는 회로도가 아니다. "
            "그래서 사인오프가 실제로 판정한 회로, 곧 <b>배선 기생이 들어간 뒤의 "
            "임계경로</b>를 게이트 기호로 그린다. 4,308셀을 다 그리면 아무도 못 읽고, "
            "이 한 경로가 주기를 정한다.")
